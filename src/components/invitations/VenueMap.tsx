  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        className="relative rounded-2xl overflow-hidden shadow-xl border-2 border-[#E8E6E3] bg-white"
      >
        {/* Google Maps Embed */}
        ...
        <motion.div
          ...
          className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-[#E8E6E3]"
        >
